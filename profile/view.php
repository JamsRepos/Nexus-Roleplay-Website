                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        ?>
                            <div class="alert alert-warning" role="alert">
                                <i class="fas fa-exclamation-triangle"></i> Your application is still under review please allow some time for us to make our decision.
                            </div>
                        <?php
                        } else if ($status == "denied") {
                        ?>
                            <div class="alert alert-danger" role="alert">
                                <i class="fas fa-exclamation-circle"></i> Your application has been denied with reason: <?=$reason?> You'll need to wait another <?=$interval->format("%a days, %h hours, %i minutes, %s seconds");?> to re-apply.
                            </div>
                        <?php
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-right">
                                        <button class="btn btn-info" onclick="location.href = '../';"><i class="fas fa-long-arrow-alt-left"></i> BACK TO PROFILE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
